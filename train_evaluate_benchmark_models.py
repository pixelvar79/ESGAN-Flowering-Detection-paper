...
# X, y, floweringdate, concdateID  = load_dataset(dir_img, dir_gt)
...
from directories import dir_img, dir_gt, dir_out
from data_loader import load_dataset, load_datasett
from models import train_knn, train_rf, train_smallcnn, train_transf
...
# Save predictions and y_test values and metrics

save_predictions(predictions,  concdateID, floweringdate, dir_out)

# Calculate and save summary metrics
summary_metrics(predictions, dir_out)